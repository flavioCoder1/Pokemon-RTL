# Seja muito bem-vindo ao meu repositório do projeto Pokédex de testes com a React Testing Library!
...
- `git clone git@github.com:flavioCoder1/Pokemon-RTL.git`.
...
# Requisitos os quais desenvolvi para testar :

### 1. Testei o componente `<App.js />`
...
### 2. Testei o componente `<About.js />.`
...
### 3. Testei o componente `<FavoritePokemons.js />`
...
### 4. Testei o componente `<NotFound.js />`
...
### 5. Testei o componente `<Pokedex.js />`
...
### 6. Testei o componente `<Pokemon.js />`
...
### 7. Testei o componente `<PokemonDetails.js />`
